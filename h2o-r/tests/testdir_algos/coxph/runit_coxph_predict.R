...
test.CoxPH.predict <- function() {
    ...
    # Case 8: categoricals, numeric... and random weights... and breslow... and strata
    tstdata.8 <- cancer
    ...
    hex.fit.8 <- h2o.coxph(x = c("age", "meal.cal", "sex"), 
                           event_column = "status", stop_column = "time", ties = "breslow",
                           stratify_by = "sex", training_frame = tstdata.hex.8)
